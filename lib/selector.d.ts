...
export interface CreateSelector<TDependencies extends object | undefined = any, TState extends object | undefined = any, TGetters extends Getters = any, TActionHelpers extends ActionHelpers = any> {
    <T extends Array<Selector<TDependencies, TState, TGetters, TActionHelpers, any>> | [Selector<TDependencies, TState, TGetters, TActionHelpers, any>], TResult>(selectors: T, combiner: (results: {
    ...
    <T1, TResult>(selector1: Selector<TDependencies, TState, TGetters, TActionHelpers, T1>, combiner: (res1: T1, context: SelectorContext<TDependencies, TState, TGetters, TActionHelpers>) => TResult): Selector<TDependencies, TState, TGetters, TActionHelpers, TResult>;
    <T1, T2, TResult>(selector1: Selector<TDependencies, TState, TGetters, TActionHelpers, T1>, selector2: Selector<TDependencies, TState, TGetters, TActionHelpers, T2>, combiner: (res1: T1, res2: T2, context: SelectorContext<TDependencies, TState, TGetters, TActionHelpers>) => TResult): Selector<TDependencies, TState, TGetters, TActionHelpers, TResult>;
    <T1, T2, T3, TResult>(selector1: Selector<TDependencies, TState, TGetters, TActionHelpers, T1>, selector2: Selector<TDependencies, TState, TGetters, TActionHelpers, T2>, selector3: Selector<TDependencies, TState, TGetters, TActionHelpers, T3>, combiner: (res1: T1, res2: T2, res3: T3, context: SelectorContext<TDependencies, TState, TGetters, TActionHelpers>) => TResult): Selector<TDependencies, TState, TGetters, TActionHelpers, TResult>;
    <T1, T2, T3, T4, TResult>(selector1: Selector<TDependencies, TState, TGetters, TActionHelpers, T1>, selector2: Selector<TDependencies, TState, TGetters, TActionHelpers, T2>, selector3: Selector<TDependencies, TState, TGetters, TActionHelpers, T3>, selector4: Selector<TDependencies, TState, TGetters, TActionHelpers, T4>, combiner: (res1: T1, res2: T2, res3: T3, res4: T4, context: SelectorContext<TDependencies, TState, TGetters, TActionHelpers>) => TResult): Selector<TDependencies, TState, TGetters, TActionHelpers, TResult>;
    <T1, T2, T3, T4, T5, TResult>(selector1: Selector<TDependencies, TState, TGetters, TActionHelpers, T1>, selector2: Selector<TDependencies, TState, TGetters, TActionHelpers, T2>, selector3: Selector<TDependencies, TState, TGetters, TActionHelpers, T3>, selector4: Selector<TDependencies, TState, TGetters, TActionHelpers, T4>, selector5: Selector<TDependencies, TState, TGetters, TActionHelpers, T5>, combiner: (res1: T1, res2: T2, res3: T3, res4: T4, res5: T5, context: SelectorContext<TDependencies, TState, TGetters, TActionHelpers>) => TResult): Selector<TDependencies, TState, TGetters, TActionHelpers, TResult>;
    <T1, T2, T3, T4, T5, T6, TResult>(selector1: Selector<TDependencies, TState, TGetters, TActionHelpers, T1>, selector2: Selector<TDependencies, TState, TGetters, TActionHelpers, T2>, selector3: Selector<TDependencies, TState, TGetters, TActionHelpers, T3>, selector4: Selector<TDependencies, TState, TGetters, TActionHelpers, T4>, selector5: Selector<TDependencies, TState, TGetters, TActionHelpers, T5>, selector6: Selector<TDependencies, TState, TGetters, TActionHelpers, T6>, combiner: (res1: T1, res2: T2, res3: T3, res4: T4, res5: T5, res6: T6, context: SelectorContext<TDependencies, TState, TGetters, TActionHelpers>) => TResult): Selector<TDependencies, TState, TGetters, TActionHelpers, TResult>;
    <T1, T2, T3, T4, T5, T6, T7, TResult>(selector1: Selector<TDependencies, TState, TGetters, TActionHelpers, T1>, selector2: Selector<TDependencies, TState, TGetters, TActionHelpers, T2>, selector3: Selector<TDependencies, TState, TGetters, TActionHelpers, T3>, selector4: Selector<TDependencies, TState, TGetters, TActionHelpers, T4>, selector5: Selector<TDependencies, TState, TGetters, TActionHelpers, T5>, selector6: Selector<TDependencies, TState, TGetters, TActionHelpers, T6>, selector7: Selector<TDependencies, TState, TGetters, TActionHelpers, T7>, combiner: (res1: T1, res2: T2, res3: T3, res4: T4, res5: T5, res6: T6, res7: T7, context: SelectorContext<TDependencies, TState, TGetters, TActionHelpers>) => TResult): Selector<TDependencies, TState, TGetters, TActionHelpers, TResult>;
    <T1, T2, T3, T4, T5, T6, T7, T8, TResult>(selector1: Selector<TDependencies, TState, TGetters, TActionHelpers, T1>, selector2: Selector<TDependencies, TState, TGetters, TActionHelpers, T2>, selector3: Selector<TDependencies, TState, TGetters, TActionHelpers, T3>, selector4: Selector<TDependencies, TState, TGetters, TActionHelpers, T4>, selector5: Selector<TDependencies, TState, TGetters, TActionHelpers, T5>, selector6: Selector<TDependencies, TState, TGetters, TActionHelpers, T6>, selector7: Selector<TDependencies, TState, TGetters, TActionHelpers, T7>, selector8: Selector<TDependencies, TState, TGetters, TActionHelpers, T8>, combiner: (res1: T1, res2: T2, res3: T3, res4: T4, res5: T5, res6: T6, res7: T7, res8: T8, context: SelectorContext<TDependencies, TState, TGetters, TActionHelpers>) => TResult): Selector<TDependencies, TState, TGetters, TActionHelpers, TResult>;
    <T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult>(selector1: Selector<TDependencies, TState, TGetters, TActionHelpers, T1>, selector2: Selector<TDependencies, TState, TGetters, TActionHelpers, T2>, selector3: Selector<TDependencies, TState, TGetters, TActionHelpers, T3>, selector4: Selector<TDependencies, TState, TGetters, TActionHelpers, T4>, selector5: Selector<TDependencies, TState, TGetters, TActionHelpers, T5>, selector6: Selector<TDependencies, TState, TGetters, TActionHelpers, T6>, selector7: Selector<TDependencies, TState, TGetters, TActionHelpers, T7>, selector8: Selector<TDependencies, TState, TGetters, TActionHelpers, T8>, selector9: Selector<TDependencies, TState, TGetters, TActionHelpers, T9>, combiner: (res1: T1, res2: T2, res3: T3, res4: T4, res5: T5, res6: T6, res7: T7, res8: T8, res9: T9, context: SelectorContext<TDependencies, TState, TGetters, TActionHelpers>) => TResult): Selector<TDependencies, TState, TGetters, TActionHelpers, TResult>;
}
